...
CREATE TABLE detalle_pedido (
  ...
  CONSTRAINT PK_DetalleP PRIMARY KEY (codigo_pedido, codigo_producto),
  CONSTRAINT FK_DetalleP_Pedido FOREIGN KEY (codigo_pedido) REFERENCES pedido (codigo_pedido),
  CONSTRAINT FK_DetalleP_Producto FOREIGN KEY (codigo_producto) REFERENCES producto (codigo_producto)
);
